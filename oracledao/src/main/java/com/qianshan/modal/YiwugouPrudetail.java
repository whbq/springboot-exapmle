...
@Table(name = "B2B2C_YIWUGOU_PRUDETAIL")
public class YiwugouPrudetail {
    ...
    @Id
    @Column(name = "TID")
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select SEQ_CONFIG_BUS_01.nextval from dual")
    private String tid;
     ...
     * 交易承诺
     */
    @Column(name = "DELIVERY_PROMISE")
    private String deliveryPromise;

    @Column(name = "ORDER_STOCKINSTRUCTION")
     ...
     * 出售产品总计
     */
    @Column(name = "PRODUCT_SELLTOTAL")
    private Integer productSelltotal;

    /**
     * 出售标语
     */
    @Column(name = "SELLFLAG")
    private String sellflag;
     ...
     * 产品图片
     */
    @Column(name = "SDI_PRODUCTS_PICLIST")
    private String sdiProductsPiclist;

    /**
     * 产品价格
     */
    @Column(name = "SDI_PRODUCTS_PRICELIST")
    private String sdiProductsPricelist;

    /**
     * 产品属性列表
     */
    @Column(name = "PRODUCT_PROPERTY_SKU_BO_LIST")
    private String productPropertySkuBoList;

    /**
     * 性能清单
     */
    @Column(name = "PROPERTY_LIST")
